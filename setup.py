...
# so bear __init__ can detect if it's being loaded in the setup
...
# bear to build the compiled extensions in sub-packages
builtins.__BEAR_SETUP__ = True
...
class CleanCommand(clean):
    ...
    # this is mostly in case we ever add a Cython module to bear
    def run(self):
        clean.run(self)
...
def do_setup():
    ...
    metadata = dict(name=PYPIDIST,
                    ...
                    keywords='software-development python package automation',
